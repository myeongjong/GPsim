...
```{r generation, warning = F, message = T, tidy = T, fig.height = 4, fig.width = 4.5, fig.align = "center", echo=T}
library(GPsim)
...
```{r fitting, warning = F, message = F, tidy = T, echo=T}
...
```{r comparison, warning = F, message = F, tidy = T, echo=T}
library(GPvecchia)
