...
```{r generation, warning = F, message = T, tidy = T, fig.height = 4, fig.width = 4.5, fig.align = "center", cache=T}
library(GPsim)
...
```{r fitting, warning = F, message = F, tidy = T, cache=T}
...
```{r comparison, warning = F, message = F, tidy = T, cache=T}
library(GPvecchia)
