...
```{r generation, warning = F, message = T, tidy = T, fig.height = 4, fig.width = 4.5, fig.align = "center", eval=T}
library(GPsim)
...
```{r fitting, warning = F, message = F, tidy = T, eval=T}
...
```{r comparison, warning = F, message = F, tidy = T, eval=T}
library(GPvecchia)
